...
const Dashboard: React.FC = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const [statsData, activityData, regStatsData] = await Promise.all([
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">Visão geral do sistema de chamados</p>
        </div>
        <Link
          to="/system-config"
      ...
      <div className="card p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Link to="/tickets" className="btn btn-secondary flex items-center justify-center space-x-2">
