...
-- Obter o ID da consulta inserida
DECLARE @consulta_id INT = SCOPE_IDENTITY();
...
-- Inserir dados de contato (usando JSON válido para SQL Server)
INSERT INTO dados_contato (id_empresa, telefones_fixos, telefones_celulares, emails) VALUES
(@empresa_id, 
 '["11 5573-0685", "11 5575-9625"]',
 '["11 94218-4319", "11 99685-5900"]',
 '["drtche.adm@gmail.com", "drtche.compras@gmail.com", "faleconosco@drtche.com.br"]'
);
...
DECLARE @scr_id INT = SCOPE_IDENTITY();
