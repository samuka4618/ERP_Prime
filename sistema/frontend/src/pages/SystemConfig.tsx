...
import { Settings, Save, Plus, Edit, Trash2, Globe, Building2, X } from 'lucide-react';
...
const SystemConfig: React.FC = () => {
  ...
  const addCustomField = (category: NewCategory | Category, isNew: boolean) => {
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Gerencie as configurações gerais do sistema de chamados
          </p>
        </div>
              ...
              <div className="mt-6 border-t pt-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button
                    ...
                    className="flex items-center space-x-2 px-3 py-1.5 text-sm bg-primary-600 text-white rounded-md hover:bg-primary-700"
                  >
                    <Plus className="w-4 h-4" />
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                  Defina quais campos aparecerão no formulário de criação de chamados para esta categoria.
                </p>
                
                {(newCategory.custom_fields || []).map((field, index) => (
                  <div key={field.id} className="mb-4 p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
                ...
                {(!newCategory.custom_fields || newCategory.custom_fields.length === 0) && (
                  <p className="text-sm text-gray-500 dark:text-gray-400 italic">
                    Nenhum campo customizado adicionado. Os campos padrão (Assunto, Descrição, Prioridade) serão usados.
                  </p>
                )}
              </div>
