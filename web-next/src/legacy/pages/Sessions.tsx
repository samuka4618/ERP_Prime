...
const Sessions: React.FC = () => {
  ...
  /** O servidor só devolve sessões com refresh válido; filtramos revogadas por segurança. */
      ...
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">
            ...
            (navegador provavelmente aberto); &quot;Inativa&quot; mantém o login válido mas sem tráfego recente.
          </p>
        </div>
