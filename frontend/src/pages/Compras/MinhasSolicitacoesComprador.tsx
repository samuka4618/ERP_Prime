...
const MinhasSolicitacoesComprador: React.FC = () => {
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-3 mb-2">
            ...
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">
              Minhas Solicitações para Cotação
            </h1>
          </div>
          <p className="text-gray-600 dark:text-gray-400">
            Solicitações aprovadas que foram atribuídas a você para realizar orçamentos
          </p>
        </div>
                  ...
                  <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    {solicitacoes.map((solicitacao) => (
                      <tr key={solicitacao.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${getStatusColor(solicitacao.status)}`}>
...
export default MinhasSolicitacoesComprador;
