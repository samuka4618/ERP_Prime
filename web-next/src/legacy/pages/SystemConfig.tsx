...
import { Plus, Edit, Trash2, Building2, X, Settings } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600 dark:text-gray-400">Carregando configurações dos módulos…</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Categorias de chamados, listas auxiliares de cadastro de clientes e pré-visualização de tema. As definições
            globais (nome do sistema, logo, SLA pré-definido, ficheiros, política de senhas, Microsoft Entra ID, datas e
            modelos de e-mail) ficam apenas em 
            <Link to="/system-settings" className="text-primary-600 dark:text-primary-400 font-medium underline-offset-2 hover:underline">
              Configurações gerais
            </Link>
            
            (<code className="text-xs bg-gray-100 dark:bg-gray-700 px-1 rounded">/system-settings</code>).
          </p>
        </div>
